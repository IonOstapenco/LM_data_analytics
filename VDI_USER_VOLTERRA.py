...
output_file = (
    base_folder /
    "VDI_USEER_VOLTERRA_026_MT.xlsx"
)
...
def read_ad_groups_files(
    ...
    for pattern in patterns:
        ...
        for current_folder in AD_folders:
            ...
            print()
            print(
                f"Mapa curenta care se analizeaza: "
                f"{current_folder}"
            )

            print(
                f"Cartella corrente analizzata: "
                f"{current_folder}"
            )
            ...
            for csv_file in csv_files:
                ...
                try:
                    ...
                    print(
                        f"    Encoding detectat: {encoding}"
                    )

                    print(
                        f"    Encoding rilevato: {encoding}"
                    )
...
def read_ad_users_attivi(
    ...
    print(
        "Se citeste AD_Users_Results_attivi.csv"
    )

    print(
        "Lettura di AD_Users_Results_attivi.csv"
    )
