...
# strucvtura de date cu mapping, pentru redenumirea coloanelor
# ca sa fie cunoscute/familiare
...
COLUMN_MAPPING = {
    ...
    "device.vmType" : "vmType",
    "device.chassisType" : "chassisType",
    "device.numberOfLogicalCores" : "numberOfLogicalCores",
    "device.numberOfCores" : "numberOfCores",
    "device.numberOfProcessors" : "numberOfProcessors",
    "device.manufacturerName" : "manufacturerName",
    "device.evidenceManufacturerName" : "evidenceManufacturerName",
    "device.evidenceModelName" : "evidenceModelName",
    "device.context.id" : "id",
    "device.context.ambiente" : "ambiente",
    "device.context.cliente" : "cliente",
    "device.context.ruolo" : "ruolo",
    "device.context.sito" : "sito",
    "device.context.stato" : "stato"
...
def write_csv(path: str, rows: List[Dict[str, Any]]) -> None:
    ...
    #flattened_rows = [flatten_dict(row) for row in rows] # --> varianta veche
    flattened_rows = []
