...
import csv
import Common as cm
import pandas as pd #c --> pentru debug
...
# Campi BGFXSW --> ICTG_0-classficiazione software
BGFXSW_field = {
    "Nome computer": 8,
    "Nome publisher": 0,
    "Nome componente": 1,
...
def carica_lista(file_name, lista):
    try:
        ...
        with open(input_file, 'r', encoding="cp1252") as fc: # --< am schimbat pentru dictreader
            for linea in fc:
...
with open(temp[0], "r") as fc:
    ...
    for h, r in enumerate(fc, 1):
        ...
        # debug pentru afisarea coloanei Metrica
